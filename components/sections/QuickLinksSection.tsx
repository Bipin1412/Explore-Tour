...
export default function QuickLinksSection({ links }: QuickLinksSectionProps) {
  return (
    <section id="quick-links" className="section-shell">
      <div className="rounded-[2.8rem] bg-[linear-gradient(135deg,#0f3550_0%,#11639b_100%)] px-6 py-10 text-white shadow-[0_30px_80px_rgba(17,99,155,0.22)] sm:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="section-tag text-[#d6edf7]">Quick Links</p>
            <h2 className="mt-4 font-display text-4xl text-white sm:text-5xl">
              Browse the major program families in one jump.
            </h2>
          </div>
          <p className="max-w-xl text-sm leading-8 text-[#d7ebf5] sm:text-base">
